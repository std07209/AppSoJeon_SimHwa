...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentList.add(new Student("짱아",17));
        studentList.add(new Student("태준",18));
        studentList.add(new Student("정우",19));
        studentList.add(new Student("해랑이",20));
        studentList.add(new Student("코난",21));
